    ...
    return <div className='packagestabs mt-5 mb-5 ' >
        ...
        <div className="tab-content container mt-4" id="myTabContent">
            ...
            <div className="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div className='mt-5'>
                    <p>App With 10 - 20 Pages Offline Database No Online Backend No Payment Gateway</p>
                </div>
                <div className='mt-5'>
                    <ul className='flex-column delivery-wrapper '>
                        <li className=''>
            ...
            <div className="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                ...
                <div className='mt-5'>
                    <p>App With 20 - 30 Pages Offline Database No Online Backend No Payment Gateway</p>
                </div>
                <div className='mt-5'>
                    <ul className='flex-column delivery-wrapper '>
                        <li className=''>
